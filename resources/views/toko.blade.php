...
<body class="bg-gradient-to-r from-blue-50 to-purple-50 min-h-screen relative">
  ...
  <div class="bg-white dark:bg-gray-900 px-44 ">
    <div class="grid grid-cols-2 auto-cols-min mt-20">
      <section class="pt-14 pb-20 ">
        <div>
          <a href="#" class="flex flex-col p-10 bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
            <img class="rounded-t-lg w-1/4" src="../img/riski amalia.png" alt="">
            <div class="flex flex-col justify-between p-4 leading-normal w-1/2">
                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Apotek Riski Amalia Medika</h5>
      ...
      <!-- <section class="pt-14 pb-20">
        <div>
          <a href="#" class="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
            <img class="object-cover w-full rounded-t-lg h-96 md:h-auto md:w-48 md:rounded-none md:rounded-s-lg" src="riski amalia.png" alt="">
  ...
  <div class="grid grid-cols-3 auto-cols-min mt-10">
    <div class="w-full max-w-xs bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 justify-self-end">
      <a href="#">
          <img class="p-8 rounded-t-lg w-3/4 mx-auto" src="../img/obat1.png" alt="product image" />
      </a>
      <div class="px-5 pb-5">
          <a href="#">
              <h5 class="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">Riski Amalia Medika</h5>
          </a>
    ...
    <div class="w-full max-w-xs bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 mx-auto">
      <a href="#">
          <img class="p-8 rounded-t-lg w-3/4 mx-auto" src="../img/obat2.png" alt="product image" />
      </a>
      <div class="px-5 pb-5">
          <a href="#">
              <h5 class="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">Riski Amalia Medika</h5>
    ...
    <div class="w-full max-w-xs bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 justify-self-start">
      <a href="#">
          <img class="p-8 rounded-t-lg w-3/4 mx-auto" src="../img/obat3.png" alt="product image" />
      </a>
      <div class="px-5 pb-5">
          <a href="#">
              <h5 class="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">Riski Amalia Medika</h5>
  ...
  <div class="grid grid-cols-3 auto-cols-min mt-10">
    <div class="w-full max-w-xs bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 justify-self-end">
      <a href="#">
          <img class="p-8 rounded-t-lg w-3/4 mx-auto" src="../img/obat4.png" alt="product image" />
      </a>
      <div class="px-5 pb-5">
          <a href="#">
              <h5 class="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">Riski Amalia Medika</h5>
    ...
    <div class="w-full max-w-xs bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 mx-auto">
      <a href="#">
          <img class="p-8 rounded-t-lg w-3/4 mx-auto" src="../img/obat5.png" alt="product image" />
      </a>
      <div class="px-5 pb-5">
          <a href="#">
              <h5 class="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">Riski Amalia Medika</h5>
    ...
    <div class="w-full max-w-xs bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 justify-self-start">
      <a href="#">
          <img class="p-8 rounded-t-lg w-3/4 mx-auto" src="../img/obat6.png" alt="product image" />
      </a>
      <div class="px-5 pb-5">
          <a href="#">
              <h5 class="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">Riski Amalia Medika</h5>
